...
| RNF9 | O aplicativo não deve ficar indisponível por mais de 24 horas (exceto sob aviso prévio) |[INT40](https://requisitos-de-software.github.io/2024.1-Consumidor.gov/Elicitação/introspec/#metodologia)|
| RNF10 | O aplicativo deve carregar interfaces e/ou componentes dentro de 20 segundos |[INT34](https://requisitos-de-software.github.io/2024.1-Consumidor.gov/Elicitação/introspec/#metodologia)|
| RNF11 | O aplicativo deve apresentar opções de suporte ao usuário (instruções de uso, FAQ, Fale conosco, fórum de dúvidas, etc.) |[INT44](https://requisitos-de-software.github.io/2024.1-Consumidor.gov/Elicitação/introspec/#metodologia)|
| RNF12 | O aplicativo deve apresentar termo de uso |[INT45](https://requisitos-de-software.github.io/2024.1-Consumidor.gov/Elicitação/introspec/#metodologia)|
| RNF13 | O aplicativo deve seguir as normas e padrões do gov.br |[INT37](https://requisitos-de-software.github.io/2024.1-Consumidor.gov/Elicitação/introspec/#metodologia)|
| RNF14 | O aplicativo deve estabelecer e seguir um padrão de cores e tamanhos para suas interfaces/componentes |[INT36](https://requisitos-de-software.github.io/2024.1-Consumidor.gov/Elicitação/introspec/#metodologia)|
