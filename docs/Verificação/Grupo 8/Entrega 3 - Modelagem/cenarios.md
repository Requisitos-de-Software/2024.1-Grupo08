...
Nesta seção, serão apresentados os resultados obtidos na verificação do artefato "[Cenários]()" na forma de um gráfico de pizza, onde são apresentadas a quantidade de "sim", "não", "não se aplica" e "incompleto" obtidos na verificação.
