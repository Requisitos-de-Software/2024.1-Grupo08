...
A Tabela 2 exemplifica como um léxico pode ser desenvolvido com base nos dados apresentados anteriormente.
...
|-----------------|-----------|------------|
| **Sujeito**     | Cliente que interage com o sistema de reservas de passagens aéreas; pode ser passageiro frequente, turista ocasional ou agente de viagens  | Cliente faz reserva de voo para uma data específica<br/><br/> Cliente cancela reserva de voo previamente agendada <br/><br/> Cliente faz check-in online para o voo <br/><br/> Cliente solicita reembolso devido a alterações no voo <br/><br/> Cliente atualiza suas informações pessoais no sistema |
